		...
		<div class="row mt-2">
			<div class="card mt-5 mx-auto w-50">
				<div class="card-header bg-info text-light text-center">
					<h2>Thank you for your visiting</h2>
				</div>
				<div class="card-body">
					<h5 class="text-center">Successfully!</h5>

					<button class="btn btn-outline-info form-control"><a href="dashboard.php">Go To TopPage</a></button>
					<button class="btn btn-outline-success form-control mt-3"><a href="logout.php">Log Out</a></button>
				</div>
			</div>
		</div>
	</div>
