			...
			<div class="card mt-5 mx-auto w-50">
				...
				<div class="card-body">
					<form action="dashboardAction.php" method="post">
						<input type="text" placeholder="Enter User Name" id="" name="username" class="form-control mt-3" required>
						<input type="password" placeholder="Enter Password" id="" name="password" class="form-control mt-3" required>

						<input type="text" placeholder="Enter Email" id="" name="email" class="form-control mt-3" required>

						<button type="submit" name="signup" class="form-control btn btn-outline-info mt-3">Sign Up</button>
					</form>
				</div>
			</div>
		</div>
