			...
			<div class="card mt-5 mx-auto w-50">
				...
				<div class="card-body">
					<form action="" method="post">
							<input type="text" placeholder="Enter Username"  id="" name="username" class="form-control" required>
              <input type="password" placeholder="Enter Password"  id="" name="password" class="form-control mt-3" required>
            <button type="submit" name="login" class="form-control btn btn-outline-success mt-3">Login</button>
          </form>
			</div>
    </div>
	</div>
